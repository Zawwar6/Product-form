...
const ProductForm = ({ speakers, setSpeakers, editingIndex, setEditingIndex }) => {
  ...
  useEffect(() => {
    if (editingIndex !== null && speakers[editingIndex]) {
      setFormData(speakers[editingIndex]);
    }
  }, [editingIndex, speakers]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex items-center justify-center p-6">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-2 text-center">
          {editingIndex !== null ? "Edit Speaker" : "Add Speaker"}
        </h2>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-4 pt-4">
            ...
            >
              {editingIndex !== null ? "Update Speaker" : "Save Speaker"}
            </button>
          </div>
        </form>
      </div>
